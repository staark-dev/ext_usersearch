...
/**
 * Search user by email ACP controller.
 */
class acp_controller
{
	...
	public function display_options()
	{
		...
		$this->language->add_lang('common', 'ssyt/usersearch');

		// Create a form key for preventing CSRF attacks
		add_form_key('ssyt_usersearch_acp');
		...
		if ($this->request->is_set_post('submit'))
		{
			...
			if (!check_form_key('ssyt_usersearch_acp'))
			{
			...
			if (empty($errors))
			{
				...
				$this->config->set('ssyt_usersearch_enable', $this->request->variable('ssyt_usersearch_enable', 0));

				// Add option settings change action to the admin log
				$this->log->add('admin', $this->user->data['user_id'], $this->user->ip, 'LOG_ACP_USERSEARCH_SETTINGS');

				// Option settings have been updated and logged
				// Confirm this to the user and provide link back to previous page
				trigger_error($this->language->lang('ACP_USERSEARCH_SETTING_SAVED') . adm_back_link($this->u_action));
			}
		}
